...
## Plots
Three different summary plots are available to visualize the results.

Firstly, there is a violin plot displaying the distribution of the theta estimates for each object obtained from different runs.
...
Secondly, there is a heatmap to check for specific patterns in the noise matrix. This information is useful when we wish to evaluate the stability of object positions in the individual assessments represented by the observed (input) ranked list.
